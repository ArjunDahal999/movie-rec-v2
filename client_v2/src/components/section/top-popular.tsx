...
const TopPopularMovie = async () => {
  const data = await fetch("http://13.60.189.142/top-popular-movies"); //fetch the data from fasytapi that is deployed in aws
...
export default TopPopularMovie;
